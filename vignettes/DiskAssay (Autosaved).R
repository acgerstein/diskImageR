...
```r
IJMacro("projectName", projectDir= "/path/to/projectDir", photoDir = "/path/to/projectDir/phogoraphs/")
```

```{r, echo=FALSE}
IJMacro("projectName", projectDir= getwd(), photoDir = file.path(getwd(), "pictures", ""))
```
