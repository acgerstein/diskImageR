...
<center>
<img src="pictures16/disk16.jpg"  style="width: 40%; height: 40%" style="float:center," alt="" />
</center> 
...
maxLik("newProject", stand="one", clearHalo=1, RAD="all", FoG=20, needML=TRUE, overwrite = TRUE, popUp = FALSE, savePDF = FALSE)
```
...
```{r,  fig.width=5, fig.height=4}
maxLik("newProject16",  stand="indiv", maxDist = 25, RAD="all", FoG=20, needML=TRUE, overwrite = TRUE, popUp = FALSE, savePDF = FALSE, needMap = TRUE)
```
