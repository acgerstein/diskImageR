...
install_git("git://github.com/acgerstein/diskImageR", build_vignettes = FALSE)
library("diskImageR")
```
...
maxLik2("newProject", clearHalo=1, standardLoc=2.5, RAD="all", FoG=20, needML=TRUE, overwrite = TRUE, popUp = FALSE, savePDF = FALSE)
```
