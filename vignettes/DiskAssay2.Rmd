...
<center>
<img src=file.path("pictures", "p2_30_a.jpg")  style="width: 35%; height: 35%" style="float:left," alt="" /> <img src=file.path("pictures", "p1_30_a.JPG")  style="width: 35%; height: 35%" style="float:left," alt="" /> 
