...
```{r}
runIJManual("vignette", projectDir= file.path(getwd(), "vignettes"), pictureDir = file.path(system.file("vignettes", "pictures", package="diskImageR"), ""), imageJLoc = "loc2")
...
maxLik("vignette", clearHalo=1, ZOI="all", needML=FALSE, popUp = TRUE, savePDF =FALSE, AUC=20)
```
...
```{r, echo=FALSE}
unlink(file.path(getwd(), "vignettes", "imageJ-out"))
```
