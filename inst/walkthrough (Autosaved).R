...
#Run the ImageJ analysis component, save the output. "projectName" shhould be changed to something of your choice (and then the same name used throughout); note that the quotation marks are required.
